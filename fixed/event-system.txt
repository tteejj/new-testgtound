...
$script:EventSystem = @{
    ...
    Events = @{
        ...
        TimeEntryAdded = "TimeEntry.Added"
...
function global:Create-EventEmitter {
    param(
...
function global:Create-ObservableProperty {
    param(
        [string]$Name,
...
function global:Register-State {
    param(
        [string]$Name,
        [hashtable]$State
    )
...
function Initialize-EventSystem {
    ...
    Subscribe-Event -EventName "DataChanged" -Handler {
        ...
        if ($EventData.Data.AffectedRegions) {
