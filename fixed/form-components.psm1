...
function global:New-NumberField {
    param(
        [hashtable]$Props = @{}
    )
...
function global:New-DatePicker {
    param(
        [hashtable]$Props = @{}
    )
...
function global:New-RadioGroup {
    param(
        [hashtable]$Props = @{}
    )
